...
# Header Menu
$header_menu_font       = technum_get_prepared_option('header_menu_font', 'main_font', 'header_menu_customize');
...
if (
    ...
    $technum_custom_css .= '
        ...
        .footer .footer-menu li a {' .
            technum_print_font_styles( $header_menu_font, array('font_family', 'font_size', 'line_height', 'text_transform', 'letter_spacing', 'word_spacing', 'font_style', 'font_weight') ) .
        '}
        .mobile-header-menu-container .main-menu > li > a,
        .slide-extra .extra-menu > li > a {' .
            technum_print_font_styles( $header_menu_font, array('font_family', 'text_transform', 'letter_spacing', 'word_spacing', 'font_style', 'font_weight') ) .
        '}
    ';
}

# Header Sub Menu
$header_sub_menu_font       = technum_get_prepared_option('header_sub_menu_font', 'main_font', 'header_menu_customize');
...
if (
    ...
    $technum_custom_css .= '
        .header .main-menu > li ul.sub-menu > li > a {' .
            technum_print_font_styles( $header_sub_menu_font, array('font_family', 'font_size', 'line_height', 'text_transform', 'letter_spacing', 'word_spacing', 'font_style', 'font_weight') ) .
        '}
        .mobile-header-menu-container .main-menu > li ul.sub-menu > li > a,
        .slide-extra .extra-menu > li ul.sub-menu > li > a {' .
            technum_print_font_styles( $header_sub_menu_font, array('font_family', 'text_transform', 'letter_spacing', 'word_spacing', 'font_style', 'font_weight') ) .
        '}
    ';
}

# Mobile Header Breakpoint
$mobile_header_breakpoint = technum_get_prepared_option('mobile_header_breakpoint');
if (
