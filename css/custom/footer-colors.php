...
// ------ Footer Colors ------- //
// ---------------------------- //
$footer_default_text_color = technum_get_prepared_option('footer_default_text_color', 'contrast_default_text_color', 'footer_customize');
...
if ( !empty($footer_dark_text_color) ) {
    $technum_custom_css .= '
        ...
        .footer .mejs-volume-total {
            background-color: rgba(' . esc_attr(technum_hex2rgb($footer_dark_text_color)) . ', 0.4);
        }
    ';
}
...
if ( !empty($footer_light_text_color) ) {
    $technum_custom_css .= '
        ...
        .footer-widgets .wp-block-latest-comments li:before {
            background-color: rgba(' . esc_attr(technum_hex2rgb($footer_light_text_color)) . ', 0.6);
        }
    ';
}
...
if ( !empty($footer_accent_text_color) ) {
    $technum_custom_css .= '
        ...
        .footer blockquote:before {
            color: rgba(' . esc_attr(technum_hex2rgb($footer_accent_text_color)) . ', 0.3);
        }
...
$footer_background_alter_color = technum_get_prepared_option('footer_background_alter_color', 'contrast_background_alter_color', 'footer_customize');
...
if ( !empty($footer_button_border_color) ) {
    $technum_custom_css .= '
        ...
        .footer-widgets .gallery .gallery-item .gallery-icon a:before {
             background-color: rgba(' . esc_attr(technum_hex2rgb($footer_button_border_color)) . ', 0.5);
        }
    ';
}
...
if ( !empty($footer_button_background_color) ) {
    $technum_custom_css .= '
        ...
        .footer-widgets .wrapper-socials a:hover {
            border-color: ' . esc_attr($footer_button_background_color) . ';
        }
    ';
}
...
if ( !empty($footer_button_background_hover) && !empty($footer_button_background_color) ) {
    $technum_custom_css .= '
        ...
        .footer-widgets .wp-block-button:not(.is-style-outline) .wp-block-button__link:not(.has-background):after {
            background: ' . esc_attr($footer_button_background_color) . ';
            background: -moz-linear-gradient(left, ' . esc_attr($footer_button_background_hover) . ' 0%, ' . esc_attr($footer_button_background_hover) . ' 50%, ' . esc_attr
        ($footer_button_background_color) . ' 50%);
            background: -webkit-gradient(linear, left top, right top, color-stop(0%, ' . esc_attr($footer_button_background_hover) . '), color-stop(50%, ' . esc_attr
        ($footer_button_background_hover) . '), color-stop(50%, ' . esc_attr($footer_button_background_color) . '));
            background: -webkit-linear-gradient(left, ' . esc_attr($footer_button_background_hover) . ' 0%, ' . esc_attr($footer_button_background_hover) . ' 50%, ' . esc_attr
        ($footer_button_background_color) .
        ' 50%);
            background: -o-linear-gradient(left, ' . esc_attr($footer_button_background_hover) . ' 0%, ' . esc_attr($footer_button_background_color) . ' 50%, ' . esc_attr
        ($footer_button_background_color) . ' 50%);
            background: -ms-linear-gradient(left, ' . esc_attr($footer_button_background_hover) . ' 0%, ' . esc_attr($footer_button_background_hover) . ' 50%, ' . esc_attr
        ($footer_button_background_color) . ' 50%);
            background: linear-gradient(to right, ' . esc_attr($footer_button_background_hover) . ' 0%, ' . esc_attr($footer_button_background_hover) . ' 50%, ' . esc_attr
        ($footer_button_background_color) . ' 50%);
        }
    ';
}