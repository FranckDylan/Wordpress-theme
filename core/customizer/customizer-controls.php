...
// Register Custom Control
    class Technum_Customize_Control extends WP_Customize_Control {
        ...
        public function enqueue() {
            wp_enqueue_script( 'technum-customizer-js', get_template_directory_uri() . '/js/customizer.js', array('jquery'), '1.0', true );
        }
        ...
        public function render_content() {
            ...
            switch ( $this->type ) {
                ...
                <?php endif; ?>
                    ...
                    $show_option_none  = esc_html__( '&mdash; Select &mdash;', 'technum' );
                    $option_none_value = '0';
                    ...
                    <button type="button" class="button-link add-new-toggle">
                        ...
                        printf( esc_html__( '+ %s', 'technum' ), get_post_type_object( 'page' )->labels->add_new_item );
                        ?>
                    </button>
                    <div class="new-content-item">
                        <label for="create-input-<?php echo esc_attr($this->id); ?>"><span class="screen-reader-text"><?php esc_html_e( 'New page title', 'technum' ); ?></span></label>
                        <input type="text" id="create-input-<?php echo esc_attr($this->id); ?>" class="create-item-input" placeholder="<?php esc_attr_e( 'New page title&hellip;', 'technum'
                        ); ?>">
                        <button type="button" class="button add-content"><?php _e( 'Add', 'technum' ); ?></button>
                    </div>
                <?php endif; ?>
                    <?php
                    break;
...
// Register Separator Control
    class Technum_Customize_Separator_Control extends Technum_Customize_Control{
...
// Register Resolution Control
    class Technum_Customize_Resolution_Control extends Technum_Customize_Control{
        ...
        public function render_content(){
            ...
            echo '<div class="customize-control-content">'; ?>
                ...
                <span class="technum-resolution-control">
                    <input type="number" step="1" pattern="\d*" size="4" value="<?php echo esc_attr($values['width']); ?>" placeholder="<?php esc_attr_e('Width', 'technum'); ?>" id="<?php
                        echo esc_attr($input_id) . '_width'; ?>" aria-describedby="<?php echo esc_attr($description_id); ?>" class="resolution-value-width" />
                    <input type="number" step="1" pattern="\d*" size="4" value="<?php echo esc_attr($values['height']); ?>" placeholder="<?php esc_attr_e('Height', 'technum'); ?>"
...
// Register Dimensions Control
    class Technum_Customize_Dimensions_Control extends Technum_Customize_Control{
        ...
        public function render_content(){
            ...
            $unit_list      = technum_get_unit_options();
            $values         = json_decode( $this->value(), true );
            ...
            echo '<div class="customize-control-content">'; ?>
                ...
                <span class="technum-dimensions-control">
                    <span class="technum-dimensions-values">
                        <?php if ( $this->show_field['top'] ) { ?>
                            <input type="number" step="1" pattern="\d*" size="4" value="<?php echo esc_attr( $values['top'] ); ?>" placeholder="<?php esc_attr_e('Top', 'technum'); ?>"
                        ...
                        <?php if ( $this->show_field['right'] ) { ?>
                            <input type="number" step="1" pattern="\d*" size="4" value="<?php echo esc_attr( $values['right'] ); ?>" placeholder="<?php esc_attr_e('Right', 'technum'); ?>" id="<?php echo esc_attr($input_id) . '_right'; ?>" aria-describedby="<?php echo esc_attr($description_id); ?>" class="dimensions-value-right" />
                        <?php } ?>
                        <?php if ( $this->show_field['bottom'] ) { ?>
                            <input type="number" step="1" pattern="\d*" size="4" value="<?php echo esc_attr( $values['bottom'] ); ?>" placeholder="<?php esc_attr_e('Bottom', 'technum'); ?>" id="<?php echo esc_attr($input_id) . '_bottom'; ?>" aria-describedby="<?php echo esc_attr($description_id); ?>" class="dimensions-value-bottom" />
                        <?php } ?>
                        <?php if ( $this->show_field['left'] ) { ?>
                            <input type="number" step="1" pattern="\d*" size="4" value="<?php echo esc_attr( $values['left'] ); ?>" placeholder="<?php esc_attr_e('Left', 'technum'); ?>" id="<?php echo esc_attr($input_id) . '_left'; ?>" aria-describedby="<?php echo esc_attr($description_id); ?>" class="dimensions-value-left" />
                        <?php } ?>
                    </span>
                    <select class="technum-dimensions-unit dimensions-value-unit" id="<?php echo esc_attr($input_id) . '_unit'; ?>">
                        <?php
...
// Register Notice Control
    class Technum_Customize_Notice_Control extends Technum_Customize_Control {
        public $type        = 'notice';
...
// Register Google Font Control
    class Technum_Customize_Google_Font_Control extends Technum_Customize_Control {
        ...
        public function __construct( $manager, $id, $args = array() ) {
            ...
            $this->fontList = $technum_fonts_array;
        }
        ...
        public function enqueue() {
            ...
            wp_enqueue_script( 'technum-customizer-js', get_template_directory_uri() . '/js/customizer.js', array('jquery', 'select2-js'), '1.0', true );
        }
        ...
        public function render_content(){
            ...
            $unit_list                  = technum_get_unit_options();
            $font_list                  = technum_get_all_font_names();
            $values                     = json_decode( $this->value(), true );
            $font_backup_list           = technum_get_backup_fonts();
            $font_text_transform_list   = technum_get_text_transform_options();
            $font_style_list            = technum_get_font_style_options();
            if ( isset($this->show_field['font_family']) && $this->show_field['font_family'] ) {
                $font_styles_options_list   = technum_get_current_font_weight_options($values['font_family']);
                $font_subset_list           = technum_get_current_font_subset_options($values['font_family']);
            }
            ...
            echo '<div class="customize-control-content">'; ?>
                <span class="technum-google-font-control">
                    ...
                    <?php if ( isset($this->show_field['font_family']) && $this->show_field['font_family'] ) { ?>
                        <span class="technum-google-font-field">
                            <span class="technum-google-font-field-label"><?php esc_html_e('Font Family', 'technum') ?></span>
                            <select class="technum-google-fonts-list font-value-font-family" id="<?php echo esc_attr($input_id) . '_font_family'; ?>" data-name="<?php echo esc_attr( $this->id ); ?>">
                                <?php
                    ...
                    <?php if (
                        ...
                        <span class="technum-google-font-field">
                            <span class="technum-google-font-field-label"><?php esc_html_e('Backup Font Family', 'technum') ?></span>
                    ...
                    <?php if (
                        ...
                        $defaultValue = !empty($values['font_styles']) ? explode( ',', $values['font_styles'] ) : '';
                        ?>
                        <span class="technum-google-font-field">
                            <span class="technum-google-font-field-label"><?php esc_html_e('Font Styles', 'technum') ?></span>
                            <span class="dropdown_select2_control">
                                ...
                                <select name="select2-list-multi[]" class="customize-control-select2 technum-google-font-styles" data-placeholder="" multiple="multiple" id="select2-<?php echo esc_attr($input_id) . '_font_styles'; ?>">
                                    <?php
                    ...
                    <?php if (
                        ...
                        $defaultValue = !empty($values['font_subset']) ? explode( ',', $values['font_subset'] ) : '';
                        ?>
                        <span class="technum-google-font-field">
                            <span class="technum-google-font-field-label"><?php esc_html_e('Font Subsets', 'technum') ?></span>
                            <span class="dropdown_select2_control">
                                ...
                                <select name="select2-list-multi[]" class="customize-control-select2 technum-google-font-subset" data-placeholder="" multiple="multiple" id="select2-<?php echo esc_attr($input_id) . '_font_subset'; ?>">
                                    <?php
                    ...
                    <?php if ( isset($this->show_field['text_transform']) && $this->show_field['text_transform'] ) { ?>
                        <span class="technum-google-font-field">
                            <span class="technum-google-font-field-label"><?php esc_html_e('Text Transform', 'technum') ?></span>
                    ...
                    <?php if ( isset($this->show_field['font_size']) && $this->show_field['font_size'] ) { ?>
                        <span class="technum-google-font-field">
                            <span class="technum-google-font-field-label"><?php esc_html_e('Font Size', 'technum'); ?></span>
                            <span class="technum-google-font-field-control">
                                ...
                                <select class="technum-font-unit font-value-font-size-unit" id="<?php echo esc_attr($input_id) . '_font_size_unit'; ?>">
                                    <?php
                                        foreach ( $unit_list as $value => $label ) {
                    ...
                    <?php if ( isset($this->show_field['line_height']) && $this->show_field['line_height'] ) { ?>
                        <span class="technum-google-font-field">
                            <span class="technum-google-font-field-label"><?php esc_html_e('Line Height', 'technum'); ?></span>
                            <span class="technum-google-font-field-control">
                                ...
                                <select class="technum-font-unit font-value-line-height-unit" id="<?php echo esc_attr($input_id) . '_line_height_unit'; ?>">
                                    <?php
                                    foreach ( $unit_list as $value => $label ) {
                    ...
                    <?php if (isset($this->show_field['letter_spacing']) &&  $this->show_field['letter_spacing'] ) { ?>
                        <span class="technum-google-font-field">
                            <span class="technum-google-font-field-label"><?php esc_html_e('Letter Spacing', 'technum'); ?></span>
                            <span class="technum-google-font-field-control">
                                ...
                                <select class="technum-font-unit font-value-letter-spacing-unit" id="<?php echo esc_attr($input_id) . '_letter_spacing_unit'; ?>">
                                    <?php
                                    foreach ( $unit_list as $value => $label ) {
                    ...
                    <?php if ( isset($this->show_field['word_spacing']) && $this->show_field['word_spacing'] ) { ?>
                        <span class="technum-google-font-field">
                            <span class="technum-google-font-field-label"><?php esc_html_e('Word Spacing', 'technum'); ?></span>
                            <span class="technum-google-font-field-control">
                                ...
                                <select class="technum-font-unit font-value-word-spacing-unit" id="<?php echo esc_attr($input_id) . '_word_spacing_unit'; ?>">
                                    <?php
                                    foreach ( $unit_list as $value => $label ) {
                    ...
                    <?php if ( isset($this->show_field['font_style']) && $this->show_field['font_style'] ) { ?>
                        <span class="technum-google-font-field">
                            <span class="technum-google-font-field-label"><?php esc_html_e('Font Style', 'technum') ?></span>
                    ...
                    <?php if ( isset($this->show_field['font_weight']) && $this->show_field['font_weight'] ) {
                        $defaultValue = !empty($values['font_weight']) ? explode( ',', $values['font_weight'] ) : '';
                        ?>
                        <span class="technum-google-font-field">
                            <span class="technum-google-font-field-label"><?php esc_html_e('Font Weight', 'technum') ?></span>
                            <select id="<?php echo esc_attr($input_id) . '_font_weight'; ?>" class="font-value-font-weight">
                                    ...
                                    if ( isset($this->show_field['font_family']) && $this->show_field['font_family'] ) {
                                        ...
                                        $font_weight_options_list = technum_get_font_weight_options();
            ...
            if ( isset($this->show_field['font_family']) && $this->show_field['font_family'] == true ) {
                $current_fonts_array = get_theme_mod('current_fonts');
...
// Register Social Icons Repeater Control
    class Technum_Customize_Socials_Control extends Technum_Customize_Control {
        ...
        public function __construct( $manager, $id, $args = array() ) {
            parent::__construct( $manager, $id, $args );
            $this->add_field_label = esc_html__('Add new field', 'technum');
            if ( ! empty( $args['add_field_label'] ) ) {
                $this->add_field_label = $args['add_field_label'];
            }

            $this->boxtitle = esc_html__( 'Customizer Socials', 'technum');
            ...
            sort( $icons );
            $icon_container = technum_icon_picker_popover(true);
        ...
        public function enqueue() {
            ...
            wp_enqueue_script( 'technum-customizer-js', get_template_directory_uri() . '/js/customizer.js', array('jquery-ui-draggable'), '1.0', true );
        }
        ...
        private function iterate_array($array = array()){
            ...
            if( !empty($array) ){
                foreach( $array as $icon ){
                    ...
                    <div class="customizer-repeater-general-control-repeater-container customizer-repeater-draggable">
                        <div class="customizer-repeater-customize-control-title">
                            <?php echo ( !empty($icon->title) ? esc_html($icon->title) : esc_html__( 'New Item', 'technum' ) ); ?>
                        </div>
                        <div class="customizer-repeater-box-content-hidden">
                            <?php
                                $this->icon_picker_control($icon_value);
                                $this->input_control(array(
                                    'label' => apply_filters('repeater_input_labels_filter', esc_html__( 'Title','technum'), $this->id, 'customizer_repeater_title_control' ),
                                    'class' => 'customizer-repeater-title-control',
                                    'type'  => apply_filters('customizer_repeater_input_types_filter', '', $this->id, 'customizer_repeater_title_control' ),
                                ), $title);
                                $this->input_control(array(
                                    'label' => apply_filters('repeater_input_labels_filter', esc_html__( 'Link','technum'), $this->id, 'customizer_repeater_link_control' ),
                            ...
                            <button type="button" class="social-repeater-general-control-remove-field" <?php if ( $it == 0 ) {
                                ...
                                <?php esc_html_e( 'Delete field', 'technum'); ?>
                            </button>
                ...
                <div class="customizer-repeater-general-control-repeater-container">
                    <div class="customizer-repeater-customize-control-title">
                        <?php esc_html_e( 'New Item', 'technum' ); ?>
                    </div>
                    <div class="customizer-repeater-box-content-hidden">
                        <?php
...
// Register Radio Buttons with Image Control
    class Technum_Customize_Imaged_Radio_Control extends Technum_Customize_Control {
...
// Register Select2 Control
    class Technum_Customize_Select2_Control extends Technum_Customize_Control {
        ...
        public function __construct( $manager, $id, $args = array(), $options = array() ) {
            ...
            if ( isset( $this->input_attrs['placeholder'] ) && $this->input_attrs['placeholder'] ) {
                ...
                $this->placeholder = esc_attr__('Please select...', 'technum');
            }
        }
        ...
        public function enqueue() {
            wp_enqueue_script('select2-js', get_template_directory_uri() . '/js/select2.min.js', array('jquery'), '1.0', true );
            wp_enqueue_style( 'select2-style', get_template_directory_uri() . '/css/select2.css' );
            wp_enqueue_script( 'technum-customizer-js', get_template_directory_uri() . '/js/customizer.js', array( 'select2-js', 'jquery' ), '1.0', true );
        }
...
// Register Media Control
    class Technum_Media_Custom_Control extends Technum_Customize_Control {
        public $type            = 'media';
        public $mime_type       = '';
        ...
        public function get_default_button_labels() {
            ...
            switch ( $mime_type ) {
                case 'video':
                    return array(
                        'select'       => esc_html__( 'Select video', 'technum' ),
                        'change'       => esc_html__( 'Change video', 'technum' ),
                        'default'      => esc_html__( 'Default', 'technum' ),
                        'remove'       => esc_html__( 'Remove', 'technum' ),
                        'placeholder'  => esc_html__( 'No video selected', 'technum' ),
                        'frame_title'  => esc_html__( 'Select video', 'technum' ),
                        'frame_button' => esc_html__( 'Choose video', 'technum' ),
                    );
                case 'audio':
                    return array(
                        'select'       => esc_html__( 'Select audio', 'technum' ),
                        'change'       => esc_html__( 'Change audio', 'technum' ),
                        'default'      => esc_html__( 'Default', 'technum' ),
                        'remove'       => esc_html__( 'Remove', 'technum' ),
                        'placeholder'  => esc_html__( 'No audio selected', 'technum' ),
                        'frame_title'  => esc_html__( 'Select audio', 'technum' ),
                        'frame_button' => esc_html__( 'Choose audio', 'technum' ),
                    );
                case 'image':
                    return array(
                        'select'       => esc_html__( 'Select image', 'technum' ),
                        'site_icon'    => esc_html__( 'Select site icon', 'technum' ),
                        'change'       => esc_html__( 'Change image', 'technum' ),
                        'default'      => esc_html__( 'Default', 'technum' ),
                        'remove'       => esc_html__( 'Remove', 'technum' ),
                        'placeholder'  => esc_html__( 'No image selected', 'technum' ),
                        'frame_title'  => esc_html__( 'Select image', 'technum' ),
                        'frame_button' => esc_html__( 'Choose image', 'technum' ),
                    );
                default:
                    return array(
                        'select'       => esc_html__( 'Select file', 'technum' ),
                        'change'       => esc_html__( 'Change file', 'technum' ),
                        'default'      => esc_html__( 'Default', 'technum' ),
                        'remove'       => esc_html__( 'Remove', 'technum' ),
                        'placeholder'  => esc_html__( 'No file selected', 'technum' ),
                        'frame_title'  => esc_html__( 'Select file', 'technum' ),
                        'frame_button' => esc_html__( 'Choose file', 'technum' ),
                    );
            }
        }
...
// Register Upload Control
    class Technum_Upload_Custom_Control extends Technum_Media_Custom_Control {
        public $type            = 'upload';
        public $mime_type       = '';
        public $button_labels   = array();
        public $removed         = '';
...
// Register Image Control
    class Technum_Image_Custom_Control extends Technum_Upload_Custom_Control {
        public $type        = 'image';
...
// Register Color Control
    class Technum_Color_Custom_Control extends Technum_Customize_Control {
        public $type = 'color';
        public $statuses;
        public $mode = 'full';

        public function __construct( $manager, $id, $args = array() ) {
            $this->statuses = array( '' => esc_html__( 'Default', 'technum' ) );
            parent::__construct( $manager, $id, $args );
        }
...
// Register Switcher Control
    class Technum_Switcher_Custom_Control extends Technum_Customize_Control {
...
// Register Alpha Color Control
    class Technum_Alpha_Color_Custom_Control extends Technum_Customize_Control {
        ...
        public function enqueue() {
            wp_enqueue_script( 'wp-color-picker' );
            wp_enqueue_script( 'technum-customizer-js', get_template_directory_uri() . '/js/customizer.js', array( 'jquery', 'wp-color-picker' ), '1.0', true );
            wp_enqueue_style( 'wp-color-picker' );
        }
